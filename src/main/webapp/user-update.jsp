                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" action="/helloservlet/user-update" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe"
                                            class="form-control form-control-line" name="fullname" value="<%=fullname%>"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" placeholder="johnathan@admin.com"
                                            class="form-control form-control-line" name="email" value="<%=email%>"
                                            id="email"> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="role_id" >
                                        	<c:forEach var="data" items="${listRole}">
                                        		<option value="${data.id}"${data.id==role_id?"selected":""}>${data.name}</option>
                                        	</c:forEach>
                                            <!-- 
